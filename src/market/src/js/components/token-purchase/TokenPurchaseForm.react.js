...
import {create} from '../../actions/tokenpurchases'
import { Segment,Input, Button,List } from 'semantic-ui-react'
import { connect } from 'react-redux';

class TokenPurchaseForm extends React.Component {
  constructor(props){
    super(props)
    ...
    return (
      <Segment>
        <form className="card" onSubmit={this._handleSubmit}>
          <List>
            <List.Item><h3 className="title">Buy tokens</h3></List.Item>
            <List.Item><p>Please enter a token address manually or select the token you want to buy</p></List.Item>
            <List.Item>
...
export default connect(()=>{return{}}, { updateTokensBalance, create })(TokenPurchaseForm);